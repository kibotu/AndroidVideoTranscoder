...
interface IFFMpegTranscoder {
     ...
     */
    fun extractFramesFromVideo(inputUri: Uri,carId : Long, @IntRange(from = 2, to = 31) photoQuality: Int = 2, frameTimes: List<String>): Observable<FFMpegTranscoder.MetaData>
     ...
     */
    fun createVideoFromFrames(outputUri: Uri, frameFolder: Uri, @IntRange(from = 0, to = 51) videoQuality: Int = 18, @IntRange(from = 1, to = 60) fps: Int = 3, deleteAfter: Boolean = true):
            Observable<FFMpegTranscoder
    .MetaData>
