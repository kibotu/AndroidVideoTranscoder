...
import com.exozet.android.core.utils.MathExtensions.log
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val uri = "Download/test.mp4".parseExternalStorageFile()

        Logger.addLogger(LogcatLogger())

//        logv("uri=$uri exists? ${"test.mp4".toUri().assetFileExists}")
        ...
        extract_frames.setOnClickListener {
            ...
            logv("extractFramesFromVideo uri=$uri")
            ...
            ffMpegTranscoder.extractFramesFromVideo(uri, "11113", 5, smallTimes)
                ...
                .subscribe({
                    ...
                    logv("extractFramesFromVideo metaData=$it")
        ...
        make_video.setOnClickListener {
            ...
            ffMpegTranscoder.createVideoFromFrames(
                Uri.fromFile(File("$downloadPath/output_${System.currentTimeMillis()}.mp4")),
                Uri.fromFile(File(frameUri.path)),
                outputFps = 24,
                ...
                .subscribe({
                    ...
                    logv("createVideoFromFrames metaData=$it")

                    Log.d(TAG, "created video location: ${it.uri}")
                }, { it.printStackTrace() }, { logv("createVideoFromFrames on complete ") })
                .addTo(subscription)
